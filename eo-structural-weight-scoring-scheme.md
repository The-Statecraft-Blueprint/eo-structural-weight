...
*Flag definitions: church-bells-flags-canonical.md v1.0*
...
The flag set is defined in full in `church-bells-flags-canonical.md` v1.0. That document is authoritative; this section summarizes for reference only.

...
Composition, by `coder_id` in `../data/eo_coding.db`:
...
The consolidated database itself — every record from every coder, fully queryable — lives at [`../data/eo_coding.db`](../data/eo_coding.db).

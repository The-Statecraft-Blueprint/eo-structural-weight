...
(ii) identify any agency actions that fail to promote access to the legal immigration system—such as the final rule entitled, "U.S. Citizenship and Immigration Services Fee Schedule and Changes to Certain Other Immigration Benefit Request Requirements," [FR] ([DATE]), in light of the Emergency Stopgap USCIS Stabilization Act (title I of division D of Public Law [PL])—and recommend steps, as appropriate and consistent with applicable law, to revise or rescind those agency actions.
...
(ii) substantially reduce current naturalization processing times; (iii) make the naturalization process more accessible to all eligible individuals, including through a potential reduction of the naturalization fee and restoration of the fee waiver process;

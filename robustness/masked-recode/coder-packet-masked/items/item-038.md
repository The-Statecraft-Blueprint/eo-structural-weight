...
(i) The USCTOC shall replace the Threat Mitigation Working Group, previously directed to lead whole-of-government efforts on TOC under Executive Order [EO-A] of [DATE] (Enforcing Federal Law With Respect to Transnational Criminal Organizations and Preventing International Trafficking). Accordingly, section 3 of Executive Order [EO-A] is hereby revoked.

...
NOW, THEREFORE, by virtue of the authority vested in me as President of the United States, and pursuant to Reorganization Plan No. 1 of [YEAR] ([STAT]), the National Security Act of [YEAR], as amended, the Defense Production Act of [YEAR], as amended, and the Federal Civil Defense Act, as amended, it is hereby ordered as follows:
TABLE OF CONTENTS
Parts
1  Purpose and Scope.
...
The Director of the Office of Emergency Preparedness, in accordance with the provisions of Executive Order No. [EO-A] of [DATE], shall advise and assist the President in determining national preparedness goals and policies for the performance of functions under this order and in coordinating the performance of such functions with the total national preparedness program.
...
In addition to the civil defense functions assigned to the Secretary of Defense by Executive Order No. [EO-B], the Secretary of Defense shall perform the following emergency preparedness functions:
...
(10) Furnish information and recommendations, when requested by the Office of Emergency Preparedness, for purposes of processing applications for defense loans under Title III of the Defense Production Act of [YEAR], as amended.
...
(5) "Minerals" means all raw materials of mineral origin (except petroleum, gas, solid fuels, and source materials as defined in the Atomic Energy Act of [YEAR], as amended) obtained by mining and like operations and processed through the stages specified and at the facilities designated in an agreement between the Secretary of the Interior and the Secretary of Commerce as being within the emergency
...
(4) Electric power and natural gas. In preparedness planning for electric power and natural gas, the Federal Power Commission shall assist the Secretary of the Interior as set forth in Section [YEAR] of this order.
Part 8
...
(e) Production, and related distribution, of minerals as defined in Subsection 702 (5), and source materials as defined in the Atomic Energy Act of [YEAR], as amended; and the construction and use of facilities designated as within the responsibilities of the Secretary of the Interior;
...
(6) Regulation and control of transfers of capital to, and reinvestment of earnings of, affiliated foreign nationals pursuant to authority conferred by Executive Order No. [EO-D] of [DATE].
...
With respect to emergency health services, as defined above, and in consonance with national civil defense plans, programs, and operation of the Department of Defense under Executive Order No. [EO-B], the Secretary of Health, Education, and Welfare shall:
...
With respect to emergency welfare services as defined above, and in consonance with national civil defense plans, programs, and operations of the Department of Defense under Executive Order No. [EO-B], the Secretary of Health, Education, and Welfare shall:
...
In consonance with national civil defense plans, programs, and operations of the Department of Defense under Executive Order No. [EO-B], the Secretary of Housing and Urban Development shall:
...
SEC. [YEAR] Functions.
The Federal Communications Commission shall develop policies, plans, and procedures, in consonance with national telecommunications plans and policies developed pursuant to Executive Order No. [EO-E], Executive Order No. [EO-F], Executive Order No. [EO-A], the Presidential Memorandum of [DATE], "Establishment of the National Communications System", and other appropriate authority, covering:
...
SECTION [YEAR] Functions.
The Federal Power Commission shall assist the Department of the Interior, in conformity with Part 7, in the preparation of national emergency plans and the development of preparedness programs for electric power and natural gas in the areas as set forth in the Memorandum of Agreement dated [DATE], between the Secretary of the Interior and the Chairman of the Federal Power Commission.
Part 20
General Services Administration
SECTION [YEAR] Resume of Responsibilities.
The Administrator of General Services shall prepare national emergency plans and develop preparedness programs designed to permit modification or expansion of the activities of the General Services Administration under the Federal Property and Administrative Services Act of [YEAR], as amended and other statutes prescribing the duties and responsibilities of the Administrator. These plans and programs shall include, but not be limited to:
...
(3) Communications. Plan for and provide, operate, and maintain appropriate telecommunications facilities designed to meet the essential requirements of Federal civilian departments and agencies during an emergency within the framework of the National Communications System. Plans and programs of the Administrator shall be in consonance with national telecommunications policies, plans, and programs developed pursuant to Executive Order No. [EO-E], Executive Order No. [EO-F], Executive Order No. [EO-A], and the Presidential Memorandum of [DATE], "Establishment of the National Communications System," or other appropriate authority.
...
SEC. [YEAR] Defense Production.
Tile Administrator of General Services shall assist the Office of Emergency Preparedness in the formulation of plans and programs relating to the certification of procurement programs, subsidy payments, and plant improvement programs provided for by the Defense Production Act of [YEAR], as amended.
SEC. [YEAR] Strategic and Critical Materials Stockpiles.
...
In consonance with the national preparedness, security, and mobilization readiness plans, programs, and operations of the Office of Emergency Preparedness under Executive Order No. [EO-A] of [DATE], and subject to the provisions of the preceding parts, the head of each department and agency shall:
...
In consonance with the national preparedness, security, and mobilization readiness plans, programs, and operations of the Office of Emergency Preparedness under Executive Order No. [EO-A], and with the national civil defense plans, programs, and operations of the Department of Defense under Executive Order No. [EO-B], the head of each department and agency shall:
...
(a) The Secretaries of Defense, Commerce, and Labor shall carry out the mandate of the National Security Council, dated [DATE], to "maintain a continuing surveillance over the Nation's manpower needs and identify any particular occupation or skill that may warrant qualifying for deferment on a uniform national basis." In addition, the Secretaries of Defense, Commerce, Labor, and Health, Education, and Welfare shall carry out the mandate of the National Security Council to "maintain a continuing surveillance over the Nation's manpower and education needs to identify any area of graduate study that may warrant qualifying for deferment in the national interest." In carrying out these functions, the Secretaries concerned shall consult with the National Science Foundation with respect to scientific manpower requirements.
...
(1) Defense Mobilization Order VI-2 of [DATE].
(2) Defense Mobilization Order 1-12 of [DATE].
(3) Executive Order No. [EO-G] of [DATE].
(4) Executive Order No. [EO-H] of [DATE].
(5) Executive Order No. [EO-I] of [DATE].
(6) Executive Order No. [EO-J] of [DATE].
(7) Executive Order No. [EO-K] of [DATE].
(8) Executive Order No. [EO-L] of [DATE].
(9) Executive Order No. [EO-M] of [DATE].
(10) Executive Order No. [EO-N] of [DATE].
(11) Executive Order No. [EO-O] of [DATE].
(12) Executive Order No. [EO-P] of [DATE].
(13) Executive Order No. [EO-Q] of [DATE].
(14) Executive Order No. [EO-R] of [DATE].
(15) Executive Order No. [EO-S] of [DATE].
(16) Executive Order No. [EO-T] of [DATE].
(17) Executive Order No. [EO-U] of [DATE].
(18) Executive Order No. [EO-V] of [DATE].
(19) Executive Order No. [EO-W] of [DATE].
(20) Executive Order No. [EO-X] of [DATE].
(21) Executive Order No. [EO-Y] of [DATE].
(22) Executive Order No. [EO-Z] of [DATE].
(23) Executive Order No. [EO-A1] of [DATE].

...
.
Purpose
. National Public Radio (NPR) and the Public Broadcasting Service (PBS) receive taxpayer funds through the Corporation for Public Broadcasting (CPB). Unlike in [YEAR], when the CPB was established, today the media landscape is filled with abundant, diverse, and innovative news options. Government funding of news media in this environment is not only outdated and unnecessary but corrosive to the appearance of journalistic independence.
